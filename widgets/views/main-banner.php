...
<section class="rev_slider_wrapper">
    <div class="rev_slider materialize-slider" >
        <ul>
            ...
            <!-- slide 1 start --> 
            <li data-transition="fade" data-slotamount="default" data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000" data-thumb="<?= Url::to(['data/img/banner-2.jpg']) ?>"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"  data-title="We are Qelopak Teknologi" data-description="">
                ...
                <div class="tp-caption NotGeneric-Title tp-resizeme"
                     ...
                     style="z-index: 5; white-space: nowrap;">We Are Qelopak Teknologi
                </div>
            ...
            <!-- slide 2 start --> 
            <li data-transition="fade" data-slotamount="default"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000"  data-thumb="assets/img/banner-2/bg.jpg"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"  data-title="Web, Mobile and Network" data-description="">
                ...
                <div class="tp-caption NotGeneric-Title tp-resizeme"
                     ...
                     data-splitout="none" 
                     data-responsive_offset="on"
                     style="z-index: 5; white-space: nowrap;">Web, Mobile and Network Development
                </div>
            ...
            <li data-transition="fade" data-slotamount="default"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000"  data-thumb="assets/img/banner-2/bg.jpg"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"  data-title="Build" data-description="">
                ...
                <div class="tp-caption NotGeneric-Title tp-resizeme"
                     ...
                     data-splitout="none" 
                     data-responsive_offset="on"
                     style="z-index: 5; white-space: nowrap;">We provide Hosting, VPS and Domain
                </div>
                ...
                <div class="tp-caption tp-resizeme rev-btn"
                     ...
                     data-responsive_offset="on"
                     style="z-index: 7; white-space: nowrap;">
                    <?= Html::a(Yii::t('app.button', 'Explore More'), ['/page/network-server-development'], ['class'=>'btn btn-lg waves-effect waves-light']) ?>
                </div>
