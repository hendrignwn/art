        ...
        <section class="rev_slider_wrapper">
         <div class="rev_slider materialize-slider" >
          <ul>
            ...
            <!-- slide 1 start --> 
            <li data-transition="fade" data-slotamount="default" data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000" data-thumb="<?= app\helpers\Url::to(['themes/v1/img/banner-1/bg.jpg']) ?>"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"  data-title="materialize Material" data-description="">

                <!-- MAIN IMAGE -->
                <img src="<?= app\helpers\Url::to(['themes/v1/img/banner-1/bg.jpg']) ?>"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
                ...
                <div class="tp-caption tp-resizeme"
                    ...
                    data-start="2000"
                    style="z-index: 5;">
                        <div><img src="<?= app\helpers\Url::to(['themes/v1/img/banner-1/dummy.jpg']) ?>" alt="" data-lazyload="<?= app\helpers\Url::to(['themes/v1/img/banner-1/book.jpg']) ?>">
                        </div>
                </div>
                ...
                <div class="tp-caption tp-resizeme"
                    ...
                    data-start="2000"
                    style="z-index: 5;">
                        <div><img src="<?= app\helpers\Url::to(['themes/v1/img/banner-1/dummy.jpg']) ?>" alt="" data-lazyload="<?= app\helpers\Url::to(['themes/v1/img/banner-1/glasses.jpg']) ?>">
                        </div>
                </div>
                ...
                <div class="tp-caption tp-resizeme"
                    ...
                    data-start="2400"
                    style="z-index: 5;">
                        <div><img src="<?= app\helpers\Url::to(['themes/v1/img/banner-1/dummy.jpg']) ?>" alt="" data-lazyload="<?= app\helpers\Url::to(['themes/v1/img/banner-1/earphones.jpg']) ?>">
                        </div>
                </div>
                ...
                <div class="tp-caption tp-resizeme"
                    ...
                    data-start="2400"
                    style="z-index: 5;">
                        <div><img src="<?= app\helpers\Url::to(['themes/v1/img/banner-1/dummy.jpg']) ?>" alt="" data-lazyload="<?= app\helpers\Url::to(['themes/v1/img/banner-1/cup.jpg']) ?>">
                        </div>
                </div>
                ...
                <div class="tp-caption tp-resizeme"
                    ...
                    data-start="2400"
                    style="z-index: 5;">
                        <div><img src="<?= app\helpers\Url::to(['themes/v1/img/banner-1/dummy.jpg']) ?>" alt="" data-lazyload="<?= app\helpers\Url::to(['themes/v1/img/banner-1/macbook.jpg']) ?>assets/img/banner-1/macbook.png">
                        </div>
                </div>
            </li>
            <!-- slide 1 end -->
            ...
            <li data-transition="fade" data-slotamount="default"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000"  data-thumb="assets/img/banner-2/bg.jpg"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"  data-title="Unique Design" data-description="">
                ...
                <!-- MAIN IMAGE -->
                <img src="<?= app\helpers\Url::to(['themes/v1/img/banner-2/bg.jpg']) ?>"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
                      ...
                      <div class="portfolio-item" data-groups='["all", "branding", "photography"]'>
                          <div class="portfolio-wrapper">
                            ...
                            <div class="thumb">
                                ...
                                <img src="<?= app\helpers\Url::to(['themes/v1/img/portfolio/portfolio-1.jpg']) ?>" alt="">
                                
                                <div class="portfolio-intro">
                                  <div class="action-btn">
                                    <a href="<?= app\helpers\Url::to(['themes/v1/img/portfolio/portfolio-1.jpg']) ?>" class="tt-lightbox" title="iOS Game Design"> <i class="fa fa-search"></i></a>
                                  </div>
                                </div>
                            </div><!-- thumb -->
                        ...
                        <form class="subscribe-form mailchimp" method="post">
                                ...
                                <div class="col-xs-12 col-md-5">
                                    <div class="input-group">
                                        <input id="subscribeEmail" type="email" name="subscribeEmail" class="form-control subscribe-input" placeholder="Type your email">
                                        <span class="input-group-btn">
                                            <button class="btn waves-effect waves-light subscribe-button btn-block" type="button">Subscribe Now</button>
                                        </span>
                                    </div>
                                    <style>
                                        .subscribe-input {
