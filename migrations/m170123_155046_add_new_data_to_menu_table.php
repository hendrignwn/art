...
class m170123_155046_add_new_data_to_menu_table extends Migration
{
    public function safeUp()
    {
        ...
        $this->insert('{{%menu}}',['id'=>'2','parent_id'=>'','name'=>'About Us','url'=>'/about-us','is_absolute_url'=>'0','option'=>'','category'=>'1','status'=>'1','order'=>'5','created_at'=>'2017-01-23 15:32:01','updated_at'=>'','created_by'=>'1','updated_by'=>'1']);
        $this->insert('{{%menu}}',['id'=>'3','parent_id'=>'','name'=>'Service','url'=>'/service','is_absolute_url'=>'0','option'=>'','category'=>'1','status'=>'1','order'=>'10','created_at'=>'2017-01-23 15:32:57','updated_at'=>'','created_by'=>'1','updated_by'=>'1']);
        $this->insert('{{%menu}}',['id'=>'4','parent_id'=>'','name'=>'Portfolio','url'=>'/portfolio','is_absolute_url'=>'0','option'=>'','category'=>'1','status'=>'1','order'=>'15','created_at'=>'2017-01-23 15:33:19','updated_at'=>'','created_by'=>'1','updated_by'=>'1']);
        ...
        $this->insert('{{%menu}}',['id'=>'6','parent_id'=>'','name'=>'Blog','url'=>'/blog','is_absolute_url'=>'0','option'=>'','category'=>'1','status'=>'1','order'=>'25','created_at'=>'2017-01-23 15:34:36','updated_at'=>'','created_by'=>'1','updated_by'=>'1']);
